        ...
        <div class="principal">
            ...
            <div class="conteudo_especifico">
                ...
                <div id="funcionalidade" class="div_direita">
                    ...
                    camera_frontal_cel, camera_traseira_cel, so_cel, bateria_cel, preco_cel, data_alteracao_cel, foto_cel FROM celular 
                                        WHERE id_cel = '$cod'";
                    ...
                    <form method="post" action="processa_altera_cel.php">
                        ...
                        <fieldset class="grupo">
                            ...
                            <div class="campo">
                                ...
                                <input type="text" name="processador" id="processador" value="<?php echo $registro[3] ?>" required>
                            </div>
                            <div class="campo">
                                <label>Memória(RAM)</label>
                                <input type="text" name="memoria" id="memoria" value="<?php echo $registro[4] ?>" required>
                            </div>
                            <div class="campo">
                                <label>Armazenamento</label>
                                <input type="text" name="armazenamento" id="armazenamento" value="<?php echo $registro[5] ?>" required>
                            </div>
                            <div class="campo">
                                <label>Câmera Frontal</label>
                                <input type="text" name="camera_frontal" id="camera_frontal" value="<?php echo $registro[6] ?>" required>
                            </div>
                            <div class="campo">
                                <label>Câmera Traseira</label>
                                <input type="text" name="camera_traseira" id="camera_traseira" value="<?php echo $registro[7] ?>"required>
                            </div>
                            <div class="campo">
                                <label>Sistema Operacional</label>
                                <input type="text" name="sistema" id="sistema" value="<?php echo $registro[8] ?>" required>
                            </div>
                            <div class="campo">
                                <label>Bateria</label>
                                <input type="text" name="bateria" id="bateria" value="<?php echo $registro[9] ?>" required>
                            </div>
                            <div class="campo">
                                <label>Preço</label>
                                <input type="text" name="preco" id="preco" value="<?php echo $registro[10] ?>" required>
                            </div>
                            <div class="campo">
								<label>Foto:<br/></label>
							</div>
