...
-- Table `mydb`.`CELULAR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`CELULAR` ;
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`FUNCIONARIOS` (`ID_FUN`, `NOME_FUN`, `CPF_FUN`, `RG_FUN`, `EMAIL_FUN`, `DATA_NASCIMENTO_FUN`, `TELEFONE_FUN`, `LOGIN_FUN`, `SENHA_FUN`, `FUNCAO_FUN`, `CARTEIRA_DE_TRABALHO_FUN`, `DATE_ADMISSÃO_FUN`, `DATA_DEMISSAO_FUN`, `UF_FUN`, `CEP_FUN`, `BAIRRO_FUN`, `ENDERECO_FUN`, `END_NUMERO_FUN`) VALUES (1, 'Administrador do Sistema', '-', '-', '-', '0000-00-00', '-', 'admin', '2', 'administrador', '-', '0000-00-00', NULL, '-', '-', '-', '-', '-');
