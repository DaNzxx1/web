							...
							<fieldset class="grupo">
								...
								<div class="campo">
									...
									<select name="funcao" id="funcao">
										<option value="estoquista" <?php if($registro[10] == "estoquista"){echo "selected";} ?>>Estoquista</option>
										<option value="vendedor" <?php if($registro[10] == "vendedor"){echo "selected";} ?>>Vendedor</option>
									</select>
								</div>
								<div class="campo">
									<label>Status</label>
									<select name="status">
										<option value="ativo" <?php if ($registro[9] == "ativo") {echo "selected";}?> >Ativo</option>
										<option value="inativo" <?php if ($registro[9] == "inativo") {echo "selected";}?> >Inativo</option>
									</select>
								</div>
								<div class="campo">
